...
<body>
	...
	<nav class="menu-navegacao">
		...
		<ul>
			...
			<li class="ativo"><a href="http://localhost/sistema-php/fornecedores.php"><i class="fa fa-bus"></i> Fornecedores </a></li>
	...
	<main class="tela-principal">
		<h2 class="titulo-secundario"><a href="cadastro-fornecedor.php"><i class="fa fa-user-plus fa-lg"></i> Cadastrar Fornecedor</a></h2>

		<h2 class="titulo-secundario">Lista de Fornecedores</h2>
		<form method=post>
